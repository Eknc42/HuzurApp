...
app.post('/api/chat', async (req, res) => {
  ...
  try {
    ...
    if (error.status === 429) {
      errorMessage = 'Arka arkaya çok fazla soru sorduğunuz için sistem geçici olarak yavaşlatıldı. Lütfen 1 dakika (60 saniye) tam olarak bekleyip tekrar deneyin.';
